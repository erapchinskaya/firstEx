package main.java.com.it.app.annotation.processor;
...
public class FileStoragePathProcessor {
    ...
    private String getPath(String name) {
        try (InputStream input = this.getClass().getClassLoader().getResourceAsStream("resources/application.properties")) {
